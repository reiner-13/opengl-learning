...
private:
    ...
    void updateCameraVectors()
    {
        ...
        // also re-calculate the Right, Up, and Front vector
        Right = glm::normalize(glm::cross(Look, WorldUp));  // normalize the vectors, because their length gets closer to 0 the more you look up or down which results in slower movement.
